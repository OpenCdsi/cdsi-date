...
namespace OpenCdsi.Calendar.Tests
{
    ...
    public class IntervalOperatorTests
    {
        ...
        public void CALCDT_1()
        {
            ...
            var i = CalendarUnit.Parse("3 years");
        ...
        public void CALCDT_2a()
        {
            ...
            var d = new DateTime(2000, 1, 1);
            var i = CalendarUnit.Parse("6 months");
        ...
        public void CALCDT_3a()
        {
            ...
            var d = new DateTime(2000, 1, 1);
            var i = CalendarUnit.Parse("3 days");
        ...
        public void CALCDT_3b()
        {
            ...
            var d = new DateTime(2000, 1, 1);
            var i = CalendarUnit.Parse("3 week");
        ...
        public void CALCDT_3c()
        {
            ...
            var i = CalendarUnit.Parse("5 week");
        ...
        public void CALCDT_4()
        {
            ...
            var i = CalendarUnit.Parse("- 4 days");
        ...
        public void CALCDT_5b()
        {
            ...
            var i = CalendarUnit.Parse("6 month");
